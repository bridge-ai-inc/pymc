function status = cartilage3Dstruct(nm, tissueName)
...
binsize     = 0.005; 	% size of each bin, eg. [cm] or [mm]
...
radius      = 0.100;   % 1/e radius of beam at tissue surface
waist       = 0.100;  	% 1/e radius of beam at focus
...
zsurf = 0.005;   % position of air/articular surface
